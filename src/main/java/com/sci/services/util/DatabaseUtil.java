	...
	public Database getDatabase() {
		...
		try {
			...
			Connection connection = DriverManager.getConnection(
					"jdbc:mysql://182.74.133.92:3306/micro_banking_dev?rewriteBatchedStatements=true&autoReconnect=true&relaxAutoCommit=true&user=sciitdev&password=welcome@1");
